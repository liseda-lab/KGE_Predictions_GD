...
for operation in operations_list:  # Embedding Operation
    for i in range(1, 11):  # Partition
        Xtrain, Ytrain = create_X_and_Y_lists(operation[0], 'Indexes_10fold/10Fold_indexes__crossvalidationTrain_Run_' + str(i) + '.txt')
        Xtest, Ytest = create_X_and_Y_lists(operation[0], 'Indexes_10fold/10Fold_indexes__crossvalidationTest_Run_' + str(i) + '.txt')
